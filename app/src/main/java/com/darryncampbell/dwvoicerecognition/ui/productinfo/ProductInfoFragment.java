package com.darryncampbell.dwvoicerecognition.ui.productinfo;
...
public class ProductInfoFragment extends Fragment implements Observer {

    String[] sentences = {
            "Price check on mustard",
            "Do we have any maple syrup in stock",
            "The baby food is out of stock"
    };
